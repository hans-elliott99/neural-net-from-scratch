...
## BACKWARD PASS
  backward = function(
            ...
            layer_dropout  ##the forward-pass dropout layer object              
){
...
activation_ReLU = list(
  ...
  #BACKWARD PASS
  backward = function(inputs, d_layer){
