...
Let's try it. Note that, due to the changes described above, we have to use the functions slightly differently, and specify that the output object is what we want to pass forward.
...
backpropagate gradients through both of the functions separately...
pdf pg/ 233
